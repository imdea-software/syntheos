...
# Bear in mind that the modules that import this one can access the z3 symbols as z3.symbol, and some do.
# For example, other modules use mnz3.And and mnz3.Implies.
# If you want to use a different theory, you have to implement those symbols too.
